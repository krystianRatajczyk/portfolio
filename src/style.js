...
export const layout = {
  section: `flex xm:flex-row flex-col ${styles.paddingY}`,
  sectionReverse: `flex xm:flex-row flex-col-reverse ${styles.paddingY}`,

  sectionImgReverse: `flex-1 flex ${styles.flexCenter} xm:mr-10 mr-0 xm:mt-0 mt-10 relative`,
  sectionImg: `flex-1 flex ${styles.flexCenter} xm:ml-10 ml-0 xm:mt-0 mt-10 relative`,

  sectionInfo: `flex-1 ${styles.flexStart} flex-col`,
  buttonPadding: `xm:px-[60px] ss:px-[75px] xs:px-[45px] py-[10px]`,
  buttonText: `xm:text-[30px] text-[30px]`,
};
